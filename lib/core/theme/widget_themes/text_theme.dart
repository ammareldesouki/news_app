...
class TTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleLarge: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w500, color: Colors.black),
    titleMedium: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w500, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleLarge: TextStyle(fontSize: 24.0, fontWeight: FontWeight.w500, color: Colors.white),
    titleMedium: TextStyle(fontSize: 20.0, fontWeight: FontWeight.w500, color: Colors.white),
